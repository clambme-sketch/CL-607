        ...
        <div className="flex flex-col items-center gap-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 items-start justify-center gap-6 sm:gap-8">
                <div className={effectContainerClasses(effectsEnabled.lowPass)}>
                    ...
                    <div className="relative w-full h-8 bg-gray-900 rounded-md"><FrequencyVisualizer isActive={isActive && effectsEnabled.lowPass} analyserNode={postFilterAnalyser} color="#3b82f6" /></div>
                    <input type="range" id="lowpass" min={0} max={100} value={freqToSlider(lowPassFreq)} onChange={handleLowPassSliderChange} disabled={!effectsEnabled.lowPass} className="w-full h-2 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-blue-600 disabled:accent-gray-500" />
                ...
                <div className={effectContainerClasses(effectsEnabled.highPass)}>
                    ...
                    <div className="relative w-full h-8 bg-gray-900 rounded-md"><FrequencyVisualizer isActive={isActive && effectsEnabled.highPass} analyserNode={postFilterAnalyser} color="#3b82f6" /></div>
                    <input type="range" id="highpass" min={0} max={100} value={freqToSlider(highPassFreq)} onChange={handleHighPassSliderChange} disabled={!effectsEnabled.highPass} className="w-full h-2 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-blue-600 disabled:accent-gray-500" />
                ...
                <div className={effectContainerClasses(effectsEnabled.sidechain)}>
                    ...
                    <div className="relative w-full h-8 bg-gray-900 rounded-md"><GainReductionMeter isActive={isActive && effectsEnabled.sidechain} analyserNode={sidechainVisualiserAnalyser} color="#3b82f6" /></div>
                    <input type="range" id="sidechain" min={0} max={1} step="0.01" value={kickSidechainAmount} onChange={handleKickSidechainChange} disabled={!effectsEnabled.sidechain} className="w-full h-2 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-blue-600 disabled:accent-gray-500" />
                ...
                <div className={effectContainerClasses(effectsEnabled.crush)}>
                    ...
                    <div className="relative w-full h-8 bg-gray-900 rounded-md"><SmallOscilloscope isActive={isActive && effectsEnabled.crush} analyserNode={crushAnalyser} color="#f97316" activeAmount={crushAmount} /></div>
                    <input type="range" id="crush" min={0} max={1} step="0.01" value={crushAmount} onChange={handleCrushChange} disabled={!effectsEnabled.crush} className="w-full h-2 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-orange-500 disabled:accent-gray-500" />
                ...
                <div className={effectContainerClasses(effectsEnabled.tape)}>
                    ...
                    <div className="relative w-full h-8 bg-gray-900 rounded-md"><SmallOscilloscope isActive={isActive && effectsEnabled.tape} analyserNode={tapeSaturationAnalyser} color="#eab308" /></div>
                    <div className={`w-full flex flex-col gap-3 p-3 rounded-lg bg-gray-900/50 ${!effectsEnabled.tape ? 'pointer-events-none' : ''}`}>
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="tape-amount" min={0} max={1} step="0.01" value={tapeSaturationAmount} onChange={handleTapeSaturationAmountChange} disabled={!effectsEnabled.tape} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-yellow-500 disabled:accent-gray-500" />
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="tape-tone" min={0} max={100} value={freqToSlider(tapeSaturationTone)} onChange={handleTapeSaturationToneChange} disabled={!effectsEnabled.tape} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-yellow-500 disabled:accent-gray-500" />
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="tape-mix" min={0} max={1} step="0.01" value={tapeSaturationMix} onChange={handleTapeSaturationMixChange} disabled={!effectsEnabled.tape} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-yellow-500 disabled:accent-gray-500" />
                ...
                <div className={effectContainerClasses(effectsEnabled.envelope)}>
                    ...
                    <div className="relative w-full h-8 bg-gray-900 rounded-md"><SmallOscilloscope isActive={isActive && effectsEnabled.envelope} analyserNode={envelopeFilterAnalyser} color="#ec4899" /></div>
                    <div className={`w-full flex flex-col gap-3 p-3 rounded-lg bg-gray-900/50 ${!effectsEnabled.envelope ? 'pointer-events-none' : ''}`}>
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="env-freq" min={0} max={100} value={freqToSlider(envelopeFilterBaseFreq)} onChange={handleEnvelopeFilterBaseFreqChange} disabled={!effectsEnabled.envelope} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-pink-500 disabled:accent-gray-500" />
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="env-q" min={0} max={1} step="0.01" value={envelopeFilterQ} onChange={handleEnvelopeFilterQChange} disabled={!effectsEnabled.envelope} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-pink-500 disabled:accent-gray-500" />
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="env-depth" min={0} max={1} step="0.01" value={envelopeFilterAmount} onChange={handleEnvelopeFilterAmountChange} disabled={!effectsEnabled.envelope} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-pink-500 disabled:accent-gray-500" />
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="env-mix" min={0} max={1} step="0.01" value={envelopeFilterMix} onChange={handleEnvelopeFilterMixChange} disabled={!effectsEnabled.envelope} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-pink-500 disabled:accent-gray-500" />
                ...
                <div className={effectContainerClasses(effectsEnabled.reverb)}>
                    ...
                    <div className="relative w-full h-8 bg-gray-900 rounded-md"><SmallOscilloscope isActive={isActive && effectsEnabled.reverb} analyserNode={reverbAnalyser} color="#a855f7" /></div>
                    <div className={`w-full flex flex-col gap-3 p-3 rounded-lg bg-gray-900/50 ${!effectsEnabled.reverb ? 'pointer-events-none' : ''}`}>
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="reverb-decay" min={0} max={1} step="0.01" value={reverbDecay} onChange={handleReverbDecayChange} disabled={!effectsEnabled.reverb} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-purple-500 disabled:accent-gray-500" />
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="reverb-mix" min={0} max={1} step="0.01" value={reverbMix} onChange={handleReverbMixChange} disabled={!effectsEnabled.reverb} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-purple-500 disabled:accent-gray-500" />
                ...
                <div className={effectContainerClasses(effectsEnabled.delay)}>
                    ...
                    <div className="relative w-full h-8 bg-gray-900 rounded-md"><SmallOscilloscope isActive={isActive && effectsEnabled.delay} analyserNode={delayAnalyser} color="#22c55e" /></div>
                    <div className={`w-full flex flex-col gap-3 p-3 rounded-lg bg-gray-900/50 ${!effectsEnabled.delay ? 'pointer-events-none' : ''}`}>
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="delay-time" min={0} max={1} step="0.01" value={delayTime} onChange={handleDelayTimeChange} disabled={!effectsEnabled.delay} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-green-500 disabled:accent-gray-500" />
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="delay-feedback" min={0} max={0.95} step="0.01" value={delayFeedback} onChange={handleDelayFeedbackChange} disabled={!effectsEnabled.delay} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-green-500 disabled:accent-gray-500" />
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <input type="range" id="delay-mix" min={0} max={1} step="0.01" value={delayMix} onChange={handleDelayMixChange} disabled={!effectsEnabled.delay} className="w-full h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-green-500 disabled:accent-gray-500" />
